...
expr1 = sp.Piecewise(
    (sp.exp(s-r)*3*x*(1-x), s < r),    # <-- factor 3 (o normaliza: x(1-x)/(1/6)*(1/2))
    (0, s >= r)
)
...
#expr3=sp.exp(-t/1000)*sp.exp(-sp.Abs(x-y)/10)
